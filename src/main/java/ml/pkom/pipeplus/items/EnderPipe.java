...
public class EnderPipe extends ExtendItem {
    ...
    public void appendTooltip(ItemAppendTooltipEvent event) {
        event.tooltip.add(TextUtil.translatable("tooltip.pipeplus.ender_pipe"));
    }

    public EnderPipe(CompatibleItemSettings settings) {
        super(settings);
    }
    ...
    public static Item newItem() {
        return ItemUtil.ofBlock(Blocks.ENDER_PIPE, getSettings());
    }
}
