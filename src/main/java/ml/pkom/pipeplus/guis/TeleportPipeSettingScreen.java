...
public class TeleportPipeSettingScreen extends HandledScreen<TeleportPipeSettingGui> {
    public static final ContainerScreenFactory<TeleportPipeSettingGui> FACTORY = TeleportPipeSettingScreen::new;
