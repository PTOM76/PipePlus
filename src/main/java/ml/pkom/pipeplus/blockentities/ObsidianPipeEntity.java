...
public class ObsidianPipeEntity extends TilePipe {
    ...
    public ObsidianPipeEntity() {
        super(BlockEntities.OBSIDIAN_PIPE_ENTITY, Blocks.OBSIDIAN_PIPE, PipeFlowItem::new);
    }
